"use strict";
/* build-hook-start *//*00001*/try { require('/home/erito/.vscode/extensions/wallabyjs.console-ninja-1.0.475/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '203935cef5a6e9c48225a7AggdBU1SXAACBwcOAVFaVgsAAg5R', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/erito/.vscode/extensions/wallabyjs.console-ninja-1.0.475/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '203935cef5a6e9c48225a7AggdBU1SXAACBwcOAVFaVgsAAg5R', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
